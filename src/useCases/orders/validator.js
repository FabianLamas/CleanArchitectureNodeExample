...
module.exports = dependencies => {
    ...
    const { useCases: { user: { getUserByIdUseCase }, product: { getProductByIdUseCase } } } = dependencies;
    ...
    return async ({ order = {} }) => {
        ...
        const products = await Promise.all(productsIds.map(id => getProductById({ id })))
